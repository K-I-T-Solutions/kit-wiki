---
title: SSH & Keys – Vollständiger Guide
...
<Aside type="tip">
**SSH-Keys > Passwörter!** Keys sind sicherer, bequemer und Voraussetzung für viele Git-Dienste (GitHub, GitLab). Einmal einrichten = nie wieder Passwort tippen! 🔑
</Aside>
...
Du solltest sehen:
- `id_ed25519` → **Private Key** (GEHEIM! Nie teilen!)
- `id_ed25519.pub` → **Public Key** (kannst du überall hinzufügen)
...
1. **Public Key vom Client kopieren**
...
2. **Auf Server: Authorized Keys bearbeiten**
...
<Aside type="note">
**Mehr SSH-Tricks gesucht?** Frag im **#nerdy-things** (Discord) oder check die [SSH-Manpage](https://man.openbsd.org/ssh) 🤓
</Aside>
